        ...
        <div class="lu-widget__body">    
            <div class="lu-t-c  datatableLoader" data-table-container data-check-container >
                ...
                <div class="lu-t-c__mass-actions lu-top">
                    <div class="lu-top__title"><span class="badge badge--primary value">0</span>&nbsp;<span style="padding-left: 10px">Items Selected</span></div>
...
{literal}
                    <div class="lu-t-c__footer table-footer">
                        ...
                        <div class="dt-buttons">
                            ...
                            <a class="t-button" tabindex="0" data-length="25" v-on:click="updateLength" aria-controls="DataTables_Table_0" href="#{/literal}{$elementId}{literal}">
                                <span>25</span>
                            </a>
