...
use ModulesGarden\Servers\VpsServer\App\UI\Backups\Modals\DeleteBackupModal;
 ...
 */
class DeleteBackupButton extends BaseModalButton implements ClientArea
{
    ...
    public function initContent()
    {
        ...
        $this->initLoadModalAction(new DeleteBackupModal());
    }
