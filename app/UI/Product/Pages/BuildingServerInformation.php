...
class BuildingServerInformation extends BaseContainer implements ClientArea, AdminArea
{
    protected $id          = 'info';
    ...
    {
        $this->customTplVars['serverinfo'] = Lang::getInstance()->T('buildingServerAccess');
    }
}
