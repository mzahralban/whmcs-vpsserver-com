...
class PendingServerInformation extends BaseContainer implements ClientArea, AdminArea
{
    protected $id          = 'info';
    ...
    {
        $this->customTplVars['serverinfo'] = Lang::getInstance()->T('pendingServerAccess');
    }
}
